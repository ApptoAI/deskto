...
- Nine new nullable columns on `threads` and five new protocol methods; no new tables. The classifier lives in `@deskto/client` and is shared by any future Surface.
